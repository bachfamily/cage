...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 280.428588999999988, 369.0, 113.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 235.785720999999995, 439.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 235.785720999999995, 372.0, 39.0, 23.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 561.0, 256.0, 32.5, 23.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 649.0, 212.0, 77.0, 23.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 579.785706000000005, 126.0, 102.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 363.57144199999999, 217.0, 104.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.785720999999999, 256.0, 102.0, 40.0 ],
									"text" : "Play synthesis"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 70.785720999999995, 303.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 70.785720999999995, 336.0, 70.0, 23.0 ],
									"text" : "metro 125"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 153.285720999999995, 293.0, 63.0, 23.0 ],
									"text" : "t b l clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 137.428588999999988, 101.0, 102.0, 25.0 ],
									"text" : "Run analysis"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 48.142864000000003, 107.0, 79.0, 23.0 ],
									"text" : "dump cents"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 561.0, 217.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 574.5, 293.0, 60.0, 23.0 ],
									"text" : "order $1"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 48.142864000000003, 137.083327999999995, 387.0, 68.916672000000005 ],
									"pitcheditrange" : [ "null" ],
									"stafflines" : [ 5 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 70.785720999999995, 508.0, 130.0, 23.0 ],
									"text" : "noteout"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 70.785720999999995, 473.0, 130.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 70.785720999999995, 439.0, 40.0, 23.0 ],
									"text" : "/ 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 153.285720999999995, 265.0, 61.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 70.785720999999995, 403.0, 184.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 153.285720999999995, 336.0, 136.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 471.847930908203125, 57.599853515625 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 584.0, 327.5, 162.785720999999995, 327.5 ],
									"source" : [ "obj-129", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 570.5, 292.0, 543.0, 292.0, 543.0, 94.0, 57.642864000000003, 94.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
,
					"patching_rect" : [ 10.0, 124.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 205.0, 215.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 75.0, 356.0, 163.0, 23.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80001
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 21.5, 455.0, 184.0, 23.0 ],
									"text" : "cage.markov.synthesis @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 341.0, 257.0, 39.0, 23.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 21.5, 313.0, 135.0, 23.0 ],
									"text" : "cage.markov.analysis"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "cage.markov.synthesis loves to work in combination with cage.markov.analysis. \nHit the bang to generate notes according to the analyzed sequence",
									"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
								}
