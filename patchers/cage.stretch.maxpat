...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 695.0, 366.20941162109375, 384.0, 43.0 ],
					"text" : "sel notes, cents = (12 * log2(( ( 2 ** ((cents/100. - 69) / 12) * $3 - $2 ) * $1 + $2 ) / $3 ) + 69 ) * 100., clearselection, sel breakpoints, cents = (12 * log2(( ( 2 ** ((cents/100. - 69) / 12) * $3 - $2 ) * $1 + $2 ) / $3 ) + 69 ) * 100., clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 661.75, 332.0, 278.0, 29.0 ],
					"text" : "sel notes, cents = ( cents - $2 ) * $1 + $2, clearselection, sel breakpoints, cents = ( cents - $2 ) * $1 + $2, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 369.525726318359375, 384.0, 43.0 ],
					"text" : "sel notes, cents = (12 * log2(( ( 2 ** ((cents/100. - 69) / 12) * $3 - $2 ) * $1 + $2 ) / $3 ) + 69 ) * 100., clearselection, sel breakpoints, cents = (12 * log2(( ( 2 ** ((cents/100. - 69) / 12) * $3 - $2 ) * $1 + $2 ) / $3 ) + 69 ) * 100., clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 661.75, 304.0, 52.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 109.0, 300.0, 52.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 624.75, 445.833343505859375, 145.0, 84.166664123535156 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.75, 335.316314697265625, 278.0, 29.0 ],
					"text" : "sel notes, cents = ( cents - $2 ) * $1 + $2, clearselection, sel breakpoints, cents = ( cents - $2 ) * $1 + $2, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 94.75, 546.0, 112.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 94.75, 442.0, 155.0, 84.166664123535156 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80002,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.75, 576.0, 25.0, 25.0 ]
				}
