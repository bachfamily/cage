...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.666664, 268.0, 94.0, 23.0 ],
					"style" : "",
					"text" : "bach.print Res"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 385.0, 237.0, 23.0 ],
					"style" : "",
					"text_width" : 191.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 228.0, 97.0, 40.0 ],
					"style" : "",
					"text" : "Pick last rewriting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 234.833344, 118.0, 23.0 ],
					"style" : "",
					"text" : "bach.print Iteration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 329.0, 186.0, 23.0 ],
					"style" : "",
					"text" : "bach.prepend (4 4) @inwrap 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 358.0, 81.0, 23.0 ],
					"style" : "",
					"text" : "bach.wrap 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 316.0, 173.0, 38.0 ],
					"style" : "",
					"text" : "bach.join 3 @outwrap 1 @set 6000 100 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 356.833344, 87.0, 23.0 ],
					"style" : "",
					"text" : "bach.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.0, 289.833344, 87.0, 23.0 ],
					"style" : "",
					"text" : "bach.pick 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 11.0, 301.0, 255.0, 23.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 129.0, 422.0, 19.0 ],
									"style" : "",
									"text" : "automessage dump cents, dump cents, sel all, preventedit - (note pitch)"
								}
...
,
					"patching_rect" : [ 59.666668, 6.333313, 117.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 834.0, 164.0, 64.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 918.25, 322.0, 81.0, 23.0 ],
					"style" : "",
					"text" : "bach.lookup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 834.0, 200.166656, 162.0, 23.0 ],
					"style" : "",
					"text" : "bach.primeser 2 none 200"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 11.0, 419.0, 496.0, 132.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 31.714286, 26.0 ],
					"zoom" : 101.193225
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 533.0, 81.0, 23.0 ],
					"style" : "",
					"text" : "bach.wrap 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 36.0, 60.0, 23.0 ],
					"style" : "",
					"text" : "bach.flat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 237.5, 81.0, 23.0 ],
					"style" : "",
					"text" : "bach.pick -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 485.0, 71.0, 23.0 ],
					"style" : "",
					"text" : "bach.trans"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 451.0, 162.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 385.833344, 90.0, 23.0 ],
					"style" : "",
					"text" : "bach.repeat 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 298.0, 57.0, 23.0 ],
					"style" : "",
					"text" : "bach./ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 681.75, 228.0, 112.0, 23.0 ],
					"style" : "",
					"text" : "bach.pick 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 818.25, 385.833344, 70.0, 23.0 ],
					"style" : "",
					"text" : "bach.f2mc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 818.25, 331.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "bach.mc2f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 818.25, 361.0, 119.0, 23.0 ],
					"style" : "",
					"text" : "bach.expr $f1 * $i2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 774.75, 420.0, 106.0, 23.0 ],
					"style" : "",
					"text" : "bach.join 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 774.75, 298.0, 106.0, 23.0 ],
					"style" : "",
					"text" : "t l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 653.75, 200.166656, 47.0, 23.0 ],
					"style" : "",
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 695.25, 152.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 695.25, 123.166656, 103.0, 23.0 ],
					"style" : "",
					"text" : "bach.=="
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 695.25, 90.166656, 76.0, 23.0 ],
					"style" : "",
					"text" : "bach.pick 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 681.75, 66.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 1.0, 0.501961, 0.0, 0.53 ],
					"bgfillcolor_angle" : 270.0,
					"bgfillcolor_autogradient" : 0.79,
					"bgfillcolor_color" : [ 0.290196, 0.309804, 0.301961, 1.0 ],
					"bgfillcolor_color1" : [ 1.0, 0.501961, 0.0, 0.53 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.666664, 157.166656, 52.0, 23.0 ],
					"style" : "",
					"text" : "( 1 $1 )",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 428.375, 558.0, 104.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.666668, 41.833313, 68.0, 21.0 ],
					"style" : "",
					"text" : "base note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.5, 5.166656, 97.0, 25.0 ],
					"style" : "",
					"text" : "Look inside!"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 155.166656, 50.0, 23.0 ],
					"style" : "",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.666664, 126.166656, 102.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 11.0, 191.166656, 219.0, 23.0 ],
					"style" : "",
					"text" : "cage.chain @out ntn @maxdepth -2"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 59.666668, 41.833313, 82.0, 81.5 ],
					"pitcheditrange" : "null",
					"preventedit" : [ "-", "(", "note", "pitch", ")" ],
					"showdurations" : 0,
					"showstems" : 0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 631.25, 23.166687, 378.0, 546.666626 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"angle" : 0.0,
					"bgcolor" : [ 0.001403, 0.678571, 0.002177, 0.04 ],
					"border" : 2,
					"bordercolor" : [ 0.001403, 0.678571, 0.002177, 1.0 ],
					"id" : "obj-34",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 281.333344, 549.0, 114.666656 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 668.5, 559.0, 583.5, 559.0, 583.5, 181.166656, 220.5, 181.166656 ],
					"source" : [ "obj-103", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 843.5, 241.083328, 989.75, 241.083328 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 120.5, 221.166656, 405.875, 221.166656, 405.875, 11.0, 691.25, 11.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 220.5, 260.083328, 927.75, 260.083328 ],
					"source" : [ "obj-5", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 87.166664, 151.0, 307.0, 151.0, 307.0, 6.0, 788.75, 6.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.923469, 0.772907, 0.9 ],
