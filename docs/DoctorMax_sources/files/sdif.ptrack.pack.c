/**
	...
	@description
	Pack the stream-wise separate parameters of a partial tracking SDIF analysis
	...
	@keywords
	SDIF file, analysis, partial tracking, pack, gather, join, stream

	@seealso
	bach.writesdif, cage.sdif.ptrack.unpack, cage.sdif.ptrack.toroll, cage.sdif.ptrack.assemble	
...
// @in 2 @type llll @digest Indices of Partials
// @in 3 @type llll @digest Frequencies
// @in 4 @type llll @digest Amplitudes
// @in 5 @type llll @digest Phases
