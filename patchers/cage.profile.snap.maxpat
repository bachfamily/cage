...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 66.0, 136.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "bang", "", "", "", "" ],
					"patching_rect" : [ 95.0, 66.0, 104.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					"comment" : "llll: Pitches For Snapping (Scale or Harmonic Field)",
					"id" : "obj-69",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 107.0, 111.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "bach.nearest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 107.0, 161.0, 112.0, 22.0 ],
