...
,
					"style" : "",
					"text" : "js helpstarter.js cage.profile.snap"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 539.0, 313.0, 109.0, 52.0 ],
									"style" : "",
									"text" : "C5 Db5 Eb5 F5 G5 A5 B5 C6 D6 E6 F#6 G6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 203.0, 32.5, 23.0 ],
									"style" : "",
									"text" : "30"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 203.0, 32.5, 23.0 ],
									"style" : "",
									"text" : "15"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 309.0, 426.0, 98.0, 23.0 ],
									"style" : "",
									"text" : "loadmess clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 158.0, 121.0, 64.0, 23.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 196.0, 366.5, 363.0, 40.0 ],
									"style" : "",
									"text" : "Snap the incoming pitches to the grid defined via the right inlet or as argument (as a sequence of allowed pitches)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 339.0, 313.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.0, 339.0, 194.0, 23.0 ],
									"style" : "",
									"text" : "cage.arpeggio 4000 8000 D#M7"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 165.0, 313.0, 64.0, 23.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 339.0, 160.0, 23.0 ],
									"style" : "",
									"text" : "cage.scale 4000 8000 DM"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 38.0, 366.5, 146.0, 23.0 ],
									"style" : "",
									"text" : "cage.profile.snap"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 427.0, 82.0, 23.0 ],
									"style" : "",
									"text" : "bach.wrap 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.0, 427.0, 53.0, 23.0 ],
									"style" : "",
									"text" : "[0 100]"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 38.0, 400.0, 151.0, 23.0 ],
									"style" : "",
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 38.400002, 459.0, 348.0, 83.0 ],
									"pitcheditrange" : [ "null" ],
									"showdurations" : 0,
									"stafflines" : [ 5 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 351.0, 185.0, 75.0, 40.0 ],
									"style" : "",
									"text" : "Change profile"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 130.0, 108.0, 69.0 ],
									"style" : "",
									"text" : "Choose number of notes for generation"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 22.0, 257.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 38.0, 234.0, 53.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 158.0, 150.0, 55.0, 23.0 ],
									"style" : "",
									"text" : "dump 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 158.0, 252.0, 166.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 38.0, 281.5, 139.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.profile.snap", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 247.5, 243.0, 347.0, 243.0, 347.0, 146.0, 167.5, 146.0 ],
									"source" : [ "obj-28", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "cage.profile.snap" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 370.578125, 53.625 ]
				}
