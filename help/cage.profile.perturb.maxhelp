...
,
					"text" : "js helpstarter.js cage.profile.perturb"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 331.0, 221.0, 91.0, 21.0 ],
									"text" : "loadmess 200"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 321.0, 238.0, 295.0, 25.0 ],
									"text" : "Maximum perturbation for each pitch, in cents"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 259.0, 238.0, 53.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 271.5, 148.0, 21.0 ],
									"text" : "cage.profile.perturb 200"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 94.0, 113.0, 69.0, 25.0 ],
									"text" : "Dump!"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 96.0, 229.0, 54.0, 21.0 ],
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 116.0, 79.0, 19.0 ],
									"text" : "dump cents"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.800003, 300.0, 53.0, 19.0 ],
									"text" : "(0 100)"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 9.6, 325.0, 320.0, 124.0 ],
									"pitcheditrange" : "null",
									"showdurations" : 0,
									"stafflines" : 5,
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 10.0, 141.0, 320.0, 75.0 ],
									"pitcheditrange" : "null",
									"showdurations" : 0,
									"stafflines" : 5,
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-5",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.profile.perturb" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 284.333313, 271.5, 251.0, 47.5 ]
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.profile.perturb", 120 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 418.578125, 53.625 ]
				}
