...
,
					"style" : "",
					"text" : "js helpstarter.js cage.profile.stretch"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 442.0, 456.0, 98.0, 23.0 ],
									"style" : "",
									"text" : "loadmess clear"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-5",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.profile.stretch" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 371.0, 321.0, 203.849304, 54.0 ],
									"presentation_rect" : [ 371.0, 321.0, 203.849304, 54.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 437.0, 166.0, 88.0, 23.0 ],
									"style" : "",
									"text" : "loadmess 1.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 384.0, 210.0, 99.0, 23.0 ],
									"style" : "",
									"text" : "loadmess 6000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 398.100006, 278.5, 112.0, 40.0 ],
									"style" : "",
									"text" : "Stretch factor (default: 1)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 302.299988, 237.5, 193.0, 40.0 ],
									"style" : "",
									"text" : "Central pitch (cents) for stretching (default: 6000)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 243.800003, 247.0, 53.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 342.600006, 288.0, 52.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 145.0, 319.5, 216.600006, 23.0 ],
									"style" : "",
									"text" : "cage.profile.stretch 6000 1.3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 110.0, 125.0, 69.0, 25.0 ],
									"style" : "",
									"text" : "Dump!"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 110.0, 247.0, 46.0, 23.0 ],
									"style" : "",
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 128.0, 79.0, 23.0 ],
									"style" : "",
									"text" : "dump cents"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 323.0, 53.0, 23.0 ],
									"style" : "",
									"text" : "(0 100)"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 24.6, 352.0, 320.0, 124.0 ],
									"pitcheditrange" : [ "null" ],
									"showdurations" : 0,
									"stafflines" : [ 5 ],
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 25.0, 153.0, 320.0, 75.0 ],
									"pitcheditrange" : [ "null" ],
									"showdurations" : 0,
									"stafflines" : [ 5 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.profile.stretch", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 410.539062, 53.625 ]
				}
