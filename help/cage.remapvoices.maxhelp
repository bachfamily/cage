...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 10.0, 178.0, 149.0, 185.333328 ],
									"pitcheditrange" : [ "null" ],
									"stafflines" : [ 5, 5, 5, 5 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 77.0, 376.025055, 50.0 ],
									"style" : "",
									"text" : "When working with a bach.roll, or with an addchords message, cage.remapvoices can mix together voices that are routed to the same voice number.",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 145.0, 43.0, 23.0 ],
									"style" : "",
									"text" : "dump"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 382.0, 237.0, 23.0 ],
									"style" : "",
									"text" : "cage.remapvoices (1 1) (2 1) (3 2) (4 2)"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 320.0, 178.0, 149.0, 185.333333 ],
									"pitcheditrange" : [ "null" ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.remapvoices" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 376.025055, 57.567627 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 19.5, 419.0, 304.0, 419.0, 304.0, 168.0, 329.5, 168.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
,
					"patching_rect" : [ 29.0, 137.0, 55.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 205.0, 191.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"style" : "",
					"text" : "js helpstarter.js cage.remapvoices"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 532.0, 535.0, 21.0 ],
									"style" : "",
									"text" : "cage.remapvoices works also with \"addchord\", \"addchords\" and \"addmeasures\" messages.",
									"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 172.5, 115.5, 172.0, 40.0 ],
									"style" : "",
									"text" : "Dump the content of bach.roll or bach.score"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 364.0, 91.0, 55.0 ],
									"style" : "",
									"text" : "Keep all the other voices"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 59.0, 426.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 317.0, 412.5, 188.0, 21.0 ],
									"style" : "",
									"text" : "...or with a permutation syntax:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 249.5, 350.0, 285.0, 21.0 ],
									"style" : "",
									"text" : "You can set the voices either with a list syntax..."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 348.0, 433.5, 194.0, 40.0 ],
									"style" : "",
									"text" : "Voice 1 becomes voice 4, and voice 4 becomes voice 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 295.0, 368.0, 239.5, 40.0 ],
									"style" : "",
									"text" : "Three voices will be output: the first, an empty one and the fourth."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.0, 453.5, 57.0, 23.0 ],
									"style" : "",
									"text" : "keep $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 385.5, 39.0, 23.0 ],
									"style" : "",
									"text" : "1 0 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 126.0, 43.0, 23.0 ],
									"style" : "",
									"text" : "dump"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 267.0, 451.0, 68.0, 23.0 ],
									"style" : "",
									"text" : "(1 4) (4 2)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 491.0, 149.0, 23.0 ],
									"style" : "",
									"text" : "cage.remapvoices 1 0 4"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 434.0, 152.0, 149.0, 164.0 ],
									"pitcheditrange" : [ "null" ],
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 117.0, 152.0, 149.0, 194.333344 ],
									"pitcheditrange" : [ "null" ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "cage.remapvoices", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 602.0, 114.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 126.5, 521.0, 411.0, 521.0, 411.0, 142.0, 443.5, 142.0 ],
									"source" : [ "obj-3", 0 ]
								}
